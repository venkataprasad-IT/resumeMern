...
export const AdditionalInfoForm = ({ languages, interests, updateArrayItem, addArrayItem, removeArrayItem, onBack, onSaveExit, onNext }) => {
  return (
    <div className={additionalInfoStyles.container}>
      ...
      <div className="flex justify-between mt-8 gap-2">
        ...
        <button type="button" className="btn-outline" onClick={onSaveExit}>Save & Exit</button>
...
export const CertificationInfoForm = ({ certifications, updateArrayItem, addArrayItem, removeArrayItem, onBack, onSaveExit, onNext }) => {
  return (
...
export const ContactInfoForm = ({ contactInfo, updateSection, onBack, onSaveExit, onNext }) => {
  return (
...
export const EducationDetailsForm = ({ educationInfo, updateArrayItem, addArrayItem, removeArrayItem, onBack, onSaveExit, onNext }) => {
  return (
...
export const ProfileInfoForm = ({ profileData, updateSection, onBack, onSaveExit, onNext }) => {
  return (
...
export const ProjectDetailForm = ({ projectInfo, updateArrayItem, addArrayItem, removeArrayItem, onBack, onSaveExit, onNext }) => {
  return (
...
export const SkillsInfoForm = ({ skillsInfo, updateArrayItem, addArrayItem, removeArrayItem, onBack, onSaveExit, onNext }) => {
  return (
...
export const WorkExperienceForm = ({ workExperience, updateArrayItem, addArrayItem, removeArrayItem, onBack, onSaveExit, onNext }) => {
  return (
